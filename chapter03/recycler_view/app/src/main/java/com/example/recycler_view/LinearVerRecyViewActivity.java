...
public class LinearVerRecyViewActivity extends AppCompatActivity implements IconAdapter.OnListItemClickListenner {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_linear_ver);

        MainActivity.initData(this);

        RecyclerView mRecyclerView = findViewById(R.id.linear_ver_recycler_view);
        LinearLayoutManager manager = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);
        IconAdapter mAdapter = new IconAdapter(this, IconDummyData.mIconData, R.layout.list_item_icon, this);
